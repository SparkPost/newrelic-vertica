...
describe('New Relic Instrumentation for Vertica', function() {
  let shim, vertica, instrument;
  ...
  it('should setDatastore and wrap connect', function() {
    ...
    expect(shim.wrapReturn).toHaveBeenCalledWith(
      vertica,
      'connect',
      expect.any(Function)
    );
  ...
  describe('wrapConnect', function() {
    ...
    it('should record query', function() {
      connection = { query: 'vertica query' };
      wrapConnect(shim, null, null, connection);
      expect(shim.recordQuery).toHaveBeenCalledWith(
        {},
        'query',
        expect.any(Function)
      );
  ...
  describe('describeQuery', function() {
    let connection, describeQuery, wrapConnect;
    ...
    it('should describe the query', function() {
      ...
      expect(shim.logger.trace).toHaveBeenCalledWith(
    ...
    it('should include host, database_name and port_path_or_id from connection', function() {
      ...
      expect(shim.setInternalProperty).toHaveBeenCalledWith(
        connection,
        '__NR_databaseName',
        'momo'
      );
